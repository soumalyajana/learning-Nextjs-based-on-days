...
function Navbar({ className }) {
  ...
  const iconSize = "w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14";
  ...
  className
      ...
      <Menu setActive={setActive}>
        ...
        <a
          ...
          className={cn("cursor-pointer", iconSize)}
        >
        ...
        <a
          ...
          className={cn("cursor-pointer", iconSize)}
        >
          <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
