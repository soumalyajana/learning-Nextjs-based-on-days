...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-2xl border border-transparent dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex backdrop-blur-xl justify-center space-x-4 px-8 py-3.5 ">
      {children}
    </nav>
  );
};
